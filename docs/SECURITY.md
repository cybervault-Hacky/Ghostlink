...
* **Developer API (v1)** — [docs/API_V1.md](API_V1.md) · [docs/API_SECURITY.md](API_SECURITY.md)
* **Termux integration** — [docs/TERMUX_INTEGRATION.md](TERMUX_INTEGRATION.md) · [docs/DEVICE_SECURITY.md](DEVICE_SECURITY.md)
* **Pairing** — [docs/PAIRING.md](PAIRING.md)
* **Projects** — [docs/PROJECTS.md](PROJECTS.md)
* **Developer auth & ownership** — [docs/DEVELOPER_AUTH.md](DEVELOPER_AUTH.md)
